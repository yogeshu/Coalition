...
const Sidebar = ({
  sidebarData, selectedPatient, setSelectedPatient
}) => {
  // const patients = [
  ...
  return (
    <div className={styles.sidebar}>
      ...
      <PatientList patients={sidebarData} selectedPatient={selectedPatient} searchQuery={searchQuery} setSelectedPatient={setSelectedPatient} />
    </div>
  );
};
